...
def main():
    ...
    print(f"Initiating Baseline End-to-End Ensemble Training on {device}")
    ...
    for epoch in range(TOTAL_EPOCHS):
        ...
        print(f"End of Epoch {epoch+1} | LR: {optimizer.param_groups[0]['lr']:.2e} | Train Loss: {avg_train_loss:.4f} | Val Loss: {avg_val_loss:.4f} | Val EER: {val_eer:.4f}%")
        ...
        if epochs_no_improve >= 20:
            print("\nEarly stopping triggered. Baseline Ensemble has converged.")
            break
